...
<div data-post-id="<?php the_ID(); ?>" <?php
	post_class( 'sc_team_posts_item sc_item_container post_container' . (empty($post_link) ? ' no_links' : '') );
...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'no_links' => empty($link),
												'hover' => 'zoomin',
												'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('big'), 'team-posts')
												), 'team-posts')
								);
	?>
