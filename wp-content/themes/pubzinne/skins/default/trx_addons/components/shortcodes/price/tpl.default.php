...
?><div <?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> 
	...
	foreach ($args['prices'] as $item) {
		...
		?><div class="sc_price_item sc_price_item_<?php
			echo esc_attr($args['type']);
			if (!empty($item['bg_image']) || !empty($item['image'])) echo ' with_image';
		...
		?>>
			...
			// Mask for bg image
			if (!empty($item['bg_image']) || !empty($item['bg_color']) || !empty($item['image']) ) {
			...
			if (!empty($item['image'])) {
				...
				if (!empty($item['image'])) {
					...
					?><div class="sc_price_item_image"  <?php if (!empty($item['image'])) echo ' style="background-image: url('.esc_url($item['image']).'); background-size:cover;"'; ?> >
                    <?php
                    if (!empty($item['title'])) {
