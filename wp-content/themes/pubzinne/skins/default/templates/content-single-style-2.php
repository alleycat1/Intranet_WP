...
<?php
	...
	if ( is_singular( 'post' ) || is_singular( 'attachment' ) ) {
		...
		ob_end_clean();
		if ( strpos( $pubzinne_post_header, 'post_title' ) !== false	|| strpos( $pubzinne_post_header, 'post_meta' ) !== false ) {
	...
	<div class="post_footer post_footer_single entry-footer">
		...
		if ( is_single() && ! is_attachment() ) {
			pubzinne_show_post_footer( $components = 'pages,tags,likes,share,author,prev_next');
		}
		?>
	</div>
	<?php
