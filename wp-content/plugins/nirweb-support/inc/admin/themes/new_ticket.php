...
if ( current_user_can( 'administrator' ) ) {
	$tickets = nirweb_ticket_get_list_new_ticket();
} else {
	$tickets = nirweb_ticket_get_list_new_ticket_posht( get_current_user_id() );
}
?>
...
<table class="wp-list-table widefat striped">
	...
	<tr style="border: solid 1px #ccc">
		...
		<th><a href="<?php echo get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=nirweb_ticket_send_ticket&action=edit&id=' . esc_html( $ticket->ticket_id ); ?>"
               class="su_link_tik"><?php echo $ticket->subject; ?></a></th>
		...
		<th><a href="<?php echo get_bloginfo( 'url' ) . '/wp-admin/admin.php?page=nirweb_ticket_send_ticket&action=edit&id=' . esc_html( $ticket->ticket_id ); ?>"
               class="answer_ticket_wpys"><span class="dashicons dashicons-edit"></span></a></a></th>
	</tr>
	<?php endforeach; ?>
	</tbody>
	<tfoot>
