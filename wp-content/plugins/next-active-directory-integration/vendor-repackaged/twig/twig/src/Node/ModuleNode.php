...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use Dreitier\Nadi\Vendor\Twig\Environment;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Error\LoaderError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Error\RuntimeError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Extension\SandboxExtension;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Markup;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Sandbox\SecurityError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Source;\n")
                ->write("use Dreitier\Nadi\Vendor\Twig\Template;\n\n")
            ;
        }
        $compiler
