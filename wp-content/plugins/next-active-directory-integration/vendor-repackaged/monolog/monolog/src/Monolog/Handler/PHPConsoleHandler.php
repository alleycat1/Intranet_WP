 ...
 *
 *      $logger = new \Dreitier\Nadi\Vendor\Monolog\Logger('all', array(new \Dreitier\Nadi\Vendor\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Dreitier\\Nadi\\Vendor\\Monolog\\'], // array Hide calls of classes started with...
