...
if (!\function_exists('wp_rml_create')) {
    ...
    {
        return CRUD::getInstance()->create($name, $parent, $type, $restrictions, $supress_validation, $return_existing_id);
    }
}
if (!\function_exists('wp_rml_create_p')) {
    ...
    {
        return CRUD::getInstance()->createRecursively($name, $parent, $type, $restrictions, $supress_validation);
    }
}
...
if (!\function_exists('wp_rml_selector')) {
    ...
    {
        return Structure::getInstance()->getView()->selector($options);
    }
}
if (!\function_exists('wp_rml_dropdown')) {
    ...
    {
        return Structure::getInstance()->getView()->dropdown($selected, $disabled, $useAll);
    }
}
...
if (!\function_exists('wp_rml_all_children_sql_supported')) {
    ...
    {
        return Core::getInstance()->getActivator()->supportsChildQuery($force, $type);
    }
}
